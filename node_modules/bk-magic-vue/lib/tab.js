(function (global, factory) {
	...
	var bkTabLabel = {
	  ...
	  render: function render(h) {
	    ...
	    return h("li", {
	      ...
	      "class": this.showClose ? 'has-close' : ''
	    }, [h("div", {
	      "class": "bk-tab-label"
	    }, [this.panel.$slots.label ? this.panel.$slots.label : this.panel.label]), this.showClose ? h("i", {
	  ...
	  methods: {
	    ...
	    updateActivePosition: function updateActivePosition(active) {
	      ...
	      this.$nextTick(function () {
	        ...
	        if (index !== -1) {
	          var _this5$scrollState = _this5.scrollState,
	              wrapperRect = _this5$scrollState.wrapperRect,
	              listRect = _this5$scrollState.listRect;
	          var tabLabel = _this5.$refs.tabLabel[index].$el;
	          var tabLabelRect = tabLabel.getBoundingClientRect();
	          var labelWrapperWidth = wrapperRect.width - _this5.getControllerWidth();
	          ...
	          var isLeftOutside = tabLabelRect.left < wrapperRect.left + _this5.getLeftControllerWidth();
	          var isRightOutside = tabLabelRect.right > wrapperRect.right - _this5.getRightControllerWidth();
	          if (isLeftOutside) {
	            _this5.scrollState.offset = -1 * leftThreshold;
	            _this5.scrollState.position = leftThreshold ? 'middle' : 'left';
	          } else if (isRightOutside) {
	            _this5.scrollState.offset = -1 * rightThreshold;
	            _this5.scrollState.position = listRect.width - rightThreshold === labelWrapperWidth ? 'right' : 'middle';
	          }
	        }
	      });
	    },
	...
	var __vue_render__ = function __vue_render__() {
	  ...
	  return _c('div', {
	    ...
	    class: {
	      'has-scroller': _vm.scrollState.show,
	      'has-add': _vm.addable
	    }
	  }, [_c('ul', {
	    ref: "labelList",
	    staticClass: "bk-tab-label-list",
	    style: {
	      transform: "translateX(" + _vm.scrollState.offset + "px)"
	    }
