    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        ...
        if (xhr.status < 200 || xhr.status >= 300) {
          ...
          options.fileObj.errorMsg = reponseText.message || 'upload failed';
  ...
  var script = {
    ...
    methods: {
      ...
      selectFile: function selectFile(e) {
        ...
        var files = this.accept ? this.getValidTypeFiles(originalFiles) : originalFiles;
        if (!files.length) {
          e.target.value = '';
          return;
        }
      ...
      uploadFile: function uploadFile(fileObj) {
        ...
        var uploadProgress = function uploadProgress(e) {
          if (e.lengthComputable) {
            ...
            _this4.speed = kb - _this4.total;
            _this4.total = kb;
            _this4.unit = 'kb/s';
            if (_this4.speed > 1000) {
              _this4.speed = Math.round(_this4.speed / 1000);
              _this4.unit = 'mb/s';
            }
            _this4.$emit('on-progress', e, fileObj, _this4.fileList);
          }
        ...
        var options = {
          ...
          onSuccess: function onSuccess(reponseText, fileObj) {
            _this4.handleSuccess(reponseText, fileObj);
          },
          onError: function onError(fileObj, fileList, response) {
            _this4.$emit('on-error', fileObj, fileList, response);
          },
          onDone: function onDone(fileObj) {
            _this4.handleDone(fileObj);
          }
        };
        this.isdrag = false;
      ...
      handleSuccess: function handleSuccess(response, file) {
        if (this.handleResCode(response)) {
          ...
          file.errorMsg = response.message || 'upload failed';
      ...
      handleImage: function handleImage(fileObj, file) {
        ...
        reader.onload = function (e) {
          _this5.smallImage(reader.result, fileObj);
        };
      ...
      smallImage: function smallImage(result, fileObj) {
        ...
        img.onload = function () {
          ...
          var maxWidth = _this6.theme === 'picture' ? 90 : 36;
