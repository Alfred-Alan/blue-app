(function (global, factory) {
	...
	var script$1 = {
	  ...
	  methods: {
	    ...
	    okHandler: function okHandler(e) {
	      ...
	      this.$emit('confirm');
	      this.$nextTick( _asyncToGenerator( regenerator.mark(function _callee() {
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                break;
	              case 4:
	                if (!(typeof _this2.confirmFn === 'function')) {
	                  _context.next = 23;
	                  break;
	                }
	                if (!_this2.confirmLoading) {
	                  _context.next = 20;
	                  break;
	                }
	                _context.prev = 6;
	                _this2.buttonLoading = true;
	                _context.next = 10;
	                return _this2.confirmFn(_this2);
	              case 10:
	                _context.next = 15;
	                break;
	              case 12:
	...
	Info.close = function (id, optsClose) {
	  ...
	  for (var index = 0; index < len; index++) {
	    ...
	    instance.$on('after-leave', function () {
