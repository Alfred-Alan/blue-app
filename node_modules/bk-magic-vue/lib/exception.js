    ...
    props: {
      type: {
        ...
        validator: function validator(value) {
          return ['404', '403', '500', 'building', 'empty', 'search-empty'].indexOf(value + '') > -1;
        }
      },
      scene: {
        type: String,
