(function (global, factory) {
	...
	var script = {
	  ...
	  data: function data() {
	    return {
	      ...
	      currentX: 0,
	      startX: 0,
	      slideWidth: this.comparison(this.minValue, this.value, this.maxValue),
	      startWidth: '',
	      slideLeft: this.minValue,
	      currentValue: [],
	      step: 1
	    };
	  },
	  computed: {
	    barStyle: function barStyle() {
	      var style = {};
	      style.left = "".concat(this.slideLeft, "%");
	      style.width = "".concat(this.slideWidth - this.slideLeft, "%");
	      if (this.range) {
	        style.width = "".concat(this.slideWidth - this.slideLeft, "%");
	      }
	      return style;
	    ...
	    val: function val(_val) {
	      _val = isArray$1(this.value) ? this.value : [this.value];
	      if (_val[0] !== this.currentValue[0] || _val[1] !== this.currentValue[1]) {
	        this.currentValue = _val;
	      }
	      return _val;
	    },
	    showCurrentValue: function showCurrentValue() {
	      return Math.round(this.slideWidth).toString();
	    }
	  },
	  watch: {
	    slideWidth: function slideWidth(val) {
	      this.$emit('change', _parseInt$2(val));
	    },
	    value: function value(val) {
	      this.slideWidth = val <= this.maxValue ? val >= this.minValue ? val : this.minValue : this.maxValue;
	    }
	  },
	  methods: {
	    changeSlideWidth: function changeSlideWidth(type, direction) {
	      if (this.disable) {
	        return;
	      }
	      this.pointerDown = type;
	      var distance = type === 'min' ? Math.floor(this.slideLeft) : Math.floor(this.slideWidth);
	      var pos = direction === 'left' ? distance - this.step : distance + this.step;
	      if (type === 'min') {
	        this.changeButtonPosition(pos);
	      } else {
	        this.slideWidth = pos;
	      }
	    },
	    comparison: function comparison(min, value, max) {
	    ...
	    onPointerDown: function onPointerDown(event, type) {
	      ...
	      this.startWidth = this.$refs.slider.querySelector('.slide-inner').clientWidth / this.$refs.slider.clientWidth * 100;
	      this.on(window, 'mousemove', this.onPointerDrag);
	      this.on(window, 'mouseup', this.onPointerDragEnd);
	    },
	    onPointerDragStart: function onPointerDragStart(event) {
	      this.dragging = false;
	      this.startX = event.clientX - this.slideLeft / 100 * this.$refs.slider.clientWidth;
	    },
	    onPointerDrag: function onPointerDrag(event) {
	      this.dragging = true;
	      this.currentX = event.clientX;
	      var sliderWidth = this.$refs.slider.clientWidth;
	      var diff = (this.currentX - this.startX) / sliderWidth * 100;
	      this.changeButtonPosition(diff);
	    },
	    changeButtonPosition: function changeButtonPosition(pos) {
	      if (this.pointerDown === 'min') {
	        this.slideLeft = pos;
	        this.slideLeft = this.slideLeft > this.slideWidth ? this.slideWidth : this.slideLeft < this.minValue ? this.minValue : this.slideLeft;
	      } else {
	        var total = pos + this.startWidth;
	        this.slideWidth = total > this.maxValue ? this.maxValue : total < this.minValue ? this.minValue : total;
	      }
	    },
	    onPointerDragEnd: function onPointerDragEnd() {
	      ...
	      this.pointerDown = '';
	      this.off(window, 'mousemove', this.onPointerDrag);
	      this.off(window, 'mouseup', this.onPointerDragEnd);
	    }
	  }
	};
	...
	var __vue_render__ = function __vue_render__() {
	  ...
	  return _c('div', {
	    ...
	    staticClass: "slider-button",
	    style: "left: " + _vm.slideLeft + "%",
	    attrs: {
	      "tabindex": "0"
	    },
	    on: {
	      "keydown": [function ($event) {
	        ...
	        _vm.changeSlideWidth('min');
	      }],
	      "mousedown": function mousedown($event) {
	        _vm.onPointerDown($event, 'min');
	      }
	    }
	  }) : _vm._e(), _vm.showTip ? _c('div', {
	    directives: [{
	      name: "bk-tooltips",
	      rawName: "v-bk-tooltips.top",
	      value: _vm.showCurrentValue,
	      expression: "showCurrentValue",
	      modifiers: {
	        "top": true
	      }
	    }],
	    staticClass: "slider-button",
	    style: "left: " + _vm.slideWidth + "%",
	    attrs: {
	      "tabindex": "0"
	    },
	    on: {
