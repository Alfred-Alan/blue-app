(function (global, factory) {
  ...
  var Mode = {
    ...
    ORIGINAL: {
      name: 'original',
      icon: 'bk-icon icon-unfull-screen'
    }
  };
  var mousewheelEventName = window.navigator.userAgent.match(/firefox/i) ? 'DOMMouseScroll' : 'mousewheel';
  var script = {
    name: 'elImageViewer',
    props: {
      urlList: {
    ...
    methods: {
      ...
      deviceSupportInstall: function deviceSupportInstall() {
        ...
        addEvent(document, mousewheelEventName, this._mouseWheelHandler);
      },
      deviceSupportUninstall: function deviceSupportUninstall() {
        removeEvent(document, 'keydown', this._keyDownHandler);
        removeEvent(document, mousewheelEventName, this._mouseWheelHandler);
      ...
      toggleMode: function toggleMode() {
        ...
        var modeNames = keys$1(Mode);
        var modeValues = values$1(Mode);
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c('transition', {
      ...
      staticClass: "bk-image-viewer-btn bk-image-viewer-close",
      on: {
        "click": _vm.hide
      }
    }, [_c('i', {
      ...
      staticClass: "bk-image-viewer-actions-divider"
    }), _c('i', {
      class: _vm.mode.icon,
      on: {
  ...
  var __vue_render__$1 = function __vue_render__() {
    ...
    return _c('div', {
      ...
      staticClass: "bk-image-error"
    }, [_vm._v(_vm._s(_vm.t('bk.image.error')))])]) : _c('img', _vm._g(_vm._b({
