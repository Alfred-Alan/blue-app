(function (global, factory) {
	  ...
	  return _c('div', {
	    ...
	    return _c('div', {
	      ...
	      class: {
	        ...
	        'bk-color-picker-recommend-empty-color': color === ''
	      },
	      style: {
	...
	var script$6 = {
	  ...
	  methods: {
	    ...
	    handleTabInput: function handleTabInput() {
	      if (!this.isRenderRecommend) {
	        this.$el.focus();
	      }
	    },
	    handleTabRecommend: function handleTabRecommend() {
	      this.$el.focus();
	    },
	    openDropdown: function openDropdown() {
	      ...
	      this.$nextTick(function () {
	        var input = _this.$refs.drop.$el.querySelector('.bk-color-picker-input-hex .bk-color-picker-input-value');
	        input.focus();
	        input.select();
	      });
	    },
	...
	var __vue_render__$6 = function __vue_render__() {
	  ...
	  return _c('div', {
	    ...
	    ref: "reference",
	    class: ['bk-color-picker', _vm.extCls, (_obj = {}, _obj["bk-color-picker-" + _vm.size] = _vm.size, _obj['bk-color-picker-show-dropdown'] = _vm.showDropdown, _obj['bk-color-picker-show-value'] = _vm.showValue, _obj)],
	    attrs: {
	      "tabindex": "0"
	    },
	    on: {
	    ...
	    class: ['bk-color-picker-color-square', !_vm.colorStr && 'bk-icon icon-close'],
	    style: {
