(function (global, factory) {
	  ...
	  _createClass(TableLayout, [{
	    ...
	    value: function updateScrollY() {
	      ...
	      if (this.table.$el && bodyWrapper) {
	        var body = bodyWrapper.querySelector('.bk-table-body');
	        ...
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 8:
	                _this2.store.toggleRowExpansion(row);
	              case 9:
	              case "end":
	...
	var zIndex$1 = {
	  ...
	  methods: {
	    getLocalZIndex: function getLocalZIndex() {
	...
	(function () {
	  if (!window['__bk_pop_manager']) {
	    ...
	    defineProperty$2(popManager, 'container', {
	      get: function get() {
	    ...
	    defineProperty$2(popManager, 'dialogMask', {
	      get: function get() {
	    ...
	    defineProperty$2(popManager, 'instances', {
	      get: function get() {
	...
	var script$4 = {
	  ...
	  components: {
	    bkCheckboxGroup: __vue_component__$2,
	    bkCheckbox: __vue_component__,
	    bkLink: __vue_component__$3
	  },
	  mixins: [locale.mixin],
	  data: function data() {
	    return {
	...
	var TableHeader = {
	  ...
	  methods: {
	    ...
	    handleFilterClick: function handleFilterClick(event, column) {
	      ...
	      if (!filterPanel) {
	        filterPanel = new Vue(__vue_component__$4);
	...
	var Model = Vue.extend(__vue_component__$6);
	  ...
	  methods: {
	    ...
	    minNavMove: function minNavMove() {
	      ...
	      if (this.isBottomMove) {
	        ...
	        this.slowExec(function () {
	          _this2.getListData(totalScrollHeight);
	        });
	      }
	    },
	...
	var __vue_render__$8 = function __vue_render__() {
	  ...
	  return _c('section', {
	    ...
	    style: "height: " + _vm.ulHeight + "px; top: " + -_vm.totalScrollHeight + "px; width: " + _vm.indexWidth + "px"
	    ...
	    style: "height: " + _vm.ulHeight + "px; top: " + -_vm.totalScrollHeight + "px;width: " + _vm.mainWidth + "px; left: " + _vm.mainLeft + "px"
	    ...
	    style: "left: " + (_vm.indexWidth + _vm.bottomScrollDis) + "px; width: " + _vm.bottomScrollWidth + "px",
	    on: {
	...
	var script$a = {
	  ...
	  components: {
	    bkPopover: __vue_component__$1,
	    bkOptionAll: __vue_component__$5,
	  ...
	  methods: {
	    ...
	    search: function search() {
	      ...
	      if (searchValue) {
	        ...
	        this.options.forEach(function (option) {
	          if (_this9.searchIgnoreCase) {
	            option.unmatched = option.lowerName.indexOf(searchValue) < 0;
	          } else {
	            option.unmatched = option.name.indexOf(searchValue) < 0;
	          }
	          if (option.unmatched && _this9.searchWithPinyin) {
	            var pinyinList = pinyin.parse(_this9.searchIgnoreCase ? option.lowerName : option.name).map(function (v) {
	              if (v.type === 2) {
	                return v.target.toLowerCase();
	              }
	              return v.target;
	        ...
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.prev = 0;
	                _this10.searchLoading = true;
	                _context.next = 4;
	                return _this10.remoteMethod(_this10.searchValue);
	              case 4:
	                _context.next = 9;
	                break;
	              case 6:
	...
	var __vue_render__$a = function __vue_render__() {
	  ...
	  }) : _vm._e(), _vm._t("trigger", [_vm.multiple && _vm.displayTag ? _c('bk-select-tag') : _c('div', {
	  ...
	  }) : _vm._t("default")], 2)]), !_vm.options.length ? _c('div', {
	...
	var __vue_render__$e = function __vue_render__() {
	  ...
	  return _vm.total > 0 ? _c('div', {
	    ...
	    class: ['bk-page-count', "bk-page-count-" + _vm.realityLocation]
