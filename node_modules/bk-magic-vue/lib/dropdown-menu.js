(function (global, factory) {
    ...
    var script = {
      ...
      methods: {
        ...
        show: function show() {
          ...
          var dropdownContentSlots = this.$slots['dropdown-content'] || [];
          var dropdownContentClientHeight = 12;
          dropdownContentSlots.forEach(function (dropdownContent) {
            var dropdownContentElm = dropdownContent.elm || {};
            dropdownContentClientHeight += dropdownContentElm.clientHeight || 0;
          });
          ...
          if (scrollTop + docHeight - (triggerBtnOffTop + triggerHeight) > menuHeight + OFFSET) {
            this.menuStyle = {
              ...
              'max-height': dropdownContentClientHeight + 'px'
            };
          } else {
            this.menuStyle = {
    ...
    var __vue_render__ = function __vue_render__() {
      ...
      return _c('div', {
        ...
        class: [_vm.disabled ? 'disabled' : '', _vm.fontSizeCls, _vm.extCls],
        attrs: {
          "tabindex": "0"
        },
        on: {
