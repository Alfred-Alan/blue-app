	  ...
	  _createClass(TreeNode, [{
	    ...
	    value: function removeChild(node) {
	      ...
	      nodes.forEach(function (node) {
	        ...
	        _this2.children.splice(childIndex, 1);
	      });
	    ...
	    set: function set(expanded) {
	      ...
	      this.tree.$nextTick( _asyncToGenerator( regenerator.mark(function _callee() {
	        var _yield$_this3$tree$la, _yield$_this3$tree$la2, leaf, _yield$_this3$tree$la3, data, newNodes;
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                if (!(expanded && _this3.lazy)) {
	                  _context.next = 21;
	                  break;
	                }
	                _this3.setState('loading', true);
	                _this3.setState('lazy', false);
	                _context.prev = 3;
	                _context.next = 6;
	                return _this3.tree.lazyMethod(_this3);
	              case 6:
	                _yield$_this3$tree$la = _context.sent;
	                _yield$_this3$tree$la2 = _yield$_this3$tree$la.leaf;
	                leaf = _yield$_this3$tree$la2 === void 0 ? [] : _yield$_this3$tree$la2;
	                _yield$_this3$tree$la3 = _yield$_this3$tree$la.data;
	                data = _yield$_this3$tree$la3 === void 0 ? [] : _yield$_this3$tree$la3;
	                newNodes = _this3.tree.addNode(data, _this3.id);
	...
	var script$1 = {
	  ...
	  methods: {
	    setData: function setData(data) {
	      ...
	      this.hasLine && (_this$needsCalculateN = this.needsCalculateNodes).push.apply(_this$needsCalculateN, _toConsumableArray(this.visibleNodes));
	    },
	    ...
	    initDefaultExpanded: function initDefaultExpanded() {
	      var _this2 = this;
	      this.defaultExpandedNodes.forEach(function (id) {
