(function (global, factory) {
    ...
    var script = {
      ...
      computed: {
        ...
        active: function active() {
          return this.$parent.localActive === this.name;
        }
      },
      created: function created() {
        var tabInstance = this.$parent;
        if (tabInstance.isTab) {
          tabInstance.registerPanel(this);
        } else {
          console.error('"bk-tab-panel"\'s parent element must be "bk-tab"');
        }
      },
      mounted: function mounted() {
        this.$refs.hidden && this.$refs.hidden.remove();
      },
      beforeDestroy: function beforeDestroy() {
        var tabInstance = this.$parent;
        if (tabInstance.isTab) {
          tabInstance.deletePanel(this);
        }
      }
    };
    ...
    var __vue_render__ = function __vue_render__() {
      ...
      return _vm.shouldRender ? _c('section', {
        ...
        ref: "hidden",
        staticClass: "hidden"
      }, [_vm._t("label")], 2), _vm._t("default")], 2) : _vm._e();
    };
