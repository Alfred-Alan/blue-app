		...
		if ( this.length ) {
			...
			while ( elem.length && elem[ 0 ] !== document ) {
				...
				if ( position === "absolute" || position === "relative" || position === "fixed" ) {
					...
					// we .gitignore the case of nested elements with an explicit value of 0
...
var sortable = $.widget("ui.sortable", $.ui.mouse, {
	...
	refreshPositions: function(fast) {
		...
		for (i = this.items.length - 1; i >= 0; i--){
			...
			//We .gitignore calculating positions of all connected containers when we're not over them
	...
	_create: function() {
		...
		this._on( this.menu.element, {
			mousedown: function( event ) {
				...
				// so we set a flag to know when we should .gitignore the blur event
...
var tooltip = $.widget( "ui.tooltip", {
	...
	_updateContent: function( target, event ) {
		...
		content = contentOption.call( target[0], function( response ) {
			// .gitignore async response if tooltip was closed already
